...
function initializeKV(): any {
  ...
  const url = process.env.pramith_portfolio_KV_REST_API_URL || process.env.KV_REST_API_URL;
  const token = process.env.pramith_portfolio_KV_REST_API_TOKEN || process.env.KV_REST_API_TOKEN;
